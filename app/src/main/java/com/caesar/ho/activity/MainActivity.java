...
import com.caesar.ho.adapter.DividerItemDecoration;
import com.caesar.ho.adapter.SamplesAdapter;
import com.caesar.ho.bean.Samples;
...
public class MainActivity extends Activity {
    RecyclerView rcv ;
    Class[] clazz = {BatteryActivity.class,PieChatActivity.class, ClockActivity.class,CoordinateActivity.class,EventActivity.class,
    ...
    String[] describle = {"电池自定义","水果大拼盘","时钟表盘","坐标系","事件监听",
